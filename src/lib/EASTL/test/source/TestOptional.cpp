	...
	{
		{
			...
			VERIFY(is_empty<nullopt_t>::value);
				...
				using iopt = typename Internal::optional_storage<int, DummyTracker>;
				VERIFY(is_trivially_destructible<iopt>::value);
...

			{
				...
				using iopt = typename Internal::optional_storage<NotTrivialDestructible, DummyTracker>;
				VERIFY(!is_trivially_destructible<iopt>::value);
