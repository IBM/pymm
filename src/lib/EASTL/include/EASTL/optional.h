...
namespace eastl
{
	...
	namespace Internal
	{
		...
		/// optional_storage
		///
		template<typename T, typename Tracker, bool IsTriviallyDestructible = eastl::is_trivially_destructible_v<T>>
		...
		struct optional_storage<T, Tracker, true>
		{
	...
	/// optional
	///
    template <typename T, typename R = DefaultTracker>
    class optional : private Internal::optional_storage<T, R>
    {
		typedef Internal::optional_storage<T, R> base_type;
