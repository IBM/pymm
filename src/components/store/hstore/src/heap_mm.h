...
public:
	...
	heap_mm(const heap_mm &) = delete;
	heap_mm &operator=(const heap_mm &) = delete;
	...
	const pin_control<heap_mm> &pin_control_data() const { return _pin_data; }
	const pin_control<heap_mm> &pin_control_key() const { return _pin_key; }
