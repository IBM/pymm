...
#            return weakref.ref(self.__dict__[name])
    ...
    def save(self, data, header_name, is_inplace=True, is_create_empty=False):
        checkpoint.save_manager(checkpoint, self, data, header_name, is_inplace, is_create_empty)
